...
function twitter() {
    ...
    client.get('statuses/user_timeline', { screen_name: 'John Doe', count: 20 }, function(error, tweets, response) {
        if (error) {
            error
        } else {
...
function spotify(songName) {
    ...
    if (!songName) {
        console.log("Artist(s): The Cranberries");
        console.log("Song Name: Zombie");
    } else {
